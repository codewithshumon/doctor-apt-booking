        ...
        <div className="flex justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
            ...
            <p className="text-para">
              For 30 years in a row, U.S. News & World Report has recgnized us
              as one of the best publics hospitals in the Nation and #1 in
              Texas. World Report has recgnized us as one of the best publics
              hospitals in the Nation and #1 in Texas.
            </p>
            <p className="text-para mt-[30px]">
              ...
              we con do tomorrow. Providing the best health care in the town.
            </p>
